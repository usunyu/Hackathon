...
- (void)chatRoomDidReceiveMessage:(QBChatMessage *)message fromRoomJID:(NSString *)roomJID{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:NotificationDidReceiveNewMessageFromRoom
