...
import com.latham.group.model.Data;
import com.latham.group.utils.DialogUtils;
...
public class MapActivity extends FragmentActivity implements LocationListener {
    ...
    private void initGooglePlayStatus() {
        ...
        if (status != ConnectionResult.SUCCESS) {
            ...
            int requestCode = App.PLAY_SERVICE_REQUEST_CODE;
    ...
    private void initLocationRequestBuilder() {
        ...
        getLocationsBuilder.setPerPage(App.LOCATION_PER_PAGE);
    ...
    private void initLocationManager() {
        ...
        locationManager.requestLocationUpdates(provider, App.LOCATION_MIN_TIME, 0, this);
    }
